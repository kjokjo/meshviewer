  ...
  function (ClientLayer, LabelsLayer, d3, L, moment, LocationMarker, rbush) {
    ...
    */
    ...
    return function (config, linkScale, sidebar, router) {
      ...
      */
      var baseLayer = L.tileLayer("http://api.tiles.mapbox.com/v4/kjo.lb56ppmc/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoia2pvIiwiYSI6Inlwa2xhUkUifQ.Zmw-EOmojOvfgMAJ1vCgRw", {
                                    subdomains: "1234",
                                    type: "osm",
    ...
    /*
    var mapboxUrl = "http://api.tiles.mapbox.com/v4/kjo.lb56ppmc/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoia2pvIiwiYSI6Inlwa2xhUkUifQ.Zmw-EOmojOvfgMAJ1vCgRw"
    ...
    var mapbox = new L.TileLayer(mapboxUrl, {minZoom: 8, maxZoom: 24, attribution: mapboxAttrib})
    map.addLayer(mapbox)
http://api.tiles.mapbox.com/v4/kjo.lb56ppmc/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoia2pvIiwiYSI6Inlwa2xhUkUifQ.Zmw-EOmojOvfgMAJ1vCgRw
      */
